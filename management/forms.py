...
class ClubSettingsForm(forms.ModelForm):
    ...
    class Meta:
        model = Club
        fields = ["name", "legal_name", "legal_address", "legal_zip_code", "legal_city", "payment_instructions", "contact_email", "website", "logo", "event_background", "primary_color", "secondary_color"]
        widgets = {
