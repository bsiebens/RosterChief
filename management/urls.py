...
urlpatterns = [
    ...
    path("members/<uuid:pk>/official-eligibility/", views.MemberOfficialEligibilityUpdateView.as_view(), name="member_official_eligibility_update"),
    ...
    path("signup/<uuid:pk>/cancel/", views.SignupCancelView.as_view(), name="signup_cancel"),
    path("signup/<uuid:pk>/link/", views.SignupLinkToMemberView.as_view(), name="signup_link_to_member"),
    path("volunteers/", views.VolunteerListView.as_view(), name="volunteer_list"),
    path("volunteers/<uuid:pk>/place/", views.VolunteerPlaceView.as_view(), name="volunteer_place"),
    ...
    path("number-pools/", views.NumberPoolListView.as_view(), name="number_pool_list"),
    path("number-pools/new/", views.NumberPoolCreateView.as_view(), name="number_pool_create"),
    path("number-pools/<uuid:pk>/edit/", views.NumberPoolUpdateView.as_view(), name="number_pool_update"),
    path("number-pools/<uuid:pk>/delete/", views.NumberPoolDeleteView.as_view(), name="number_pool_delete"),
    ...
    path("official-levels/", views.OfficialLevelListView.as_view(), name="official_level_list"),
    path("official-levels/new/", views.OfficialLevelCreateView.as_view(), name="official_level_create"),
    path("official-levels/<uuid:pk>/edit/", views.OfficialLevelUpdateView.as_view(), name="official_level_update"),
    path("official-levels/<uuid:pk>/delete/", views.OfficialLevelDeleteView.as_view(), name="official_level_delete"),
    # News
    ...
    path("events/<uuid:pk>/officials/assign/", views.EventOfficialAssignView.as_view(), name="event_official_assign"),
    path("events/<uuid:pk>/officials/add-external/", views.EventOfficialAddExternalView.as_view(), name="event_official_add_external"),
    path("events/<uuid:pk>/officials/<uuid:official_pk>/remove/", views.EventOfficialRemoveView.as_view(), name="event_official_remove"),
    path("events/<uuid:pk>/officials/<uuid:official_pk>/fee/", views.EventOfficialFeeUpdateView.as_view(), name="event_official_fee_update"),
    path("events/<uuid:pk>/officials/form-pdf/", views.EventOfficialFormPdfView.as_view(), name="event_official_form_pdf"),
    path("events/<uuid:pk>/tasks/create/", views.EventTaskCreateView.as_view(), name="event_task_create"),
    path("events/<uuid:pk>/tasks/<uuid:task_pk>/update/", views.EventTaskUpdateView.as_view(), name="event_task_update"),
    path("events/<uuid:pk>/tasks/<uuid:task_pk>/delete/", views.EventTaskDeleteView.as_view(), name="event_task_delete"),
    ...
    path("events/dfel-import/", views.DFELImportView.as_view(), name="dfel_import"),
    path("events/dfel-import/confirm/", views.DFELImportConfirmView.as_view(), name="dfel_import_confirm"),
    ...
    path("shop/categories/new/", views.ProductCategoryCreateView.as_view(), name="product_category_create"),
    path("shop/categories/<uuid:pk>/edit/", views.ProductCategoryUpdateView.as_view(), name="product_category_update"),
    path("shop/categories/<uuid:pk>/delete/", views.ProductCategoryDeleteView.as_view(), name="product_category_delete"),
    path("shop/orders/", views.OrderListView.as_view(), name="order_list"),
    path("shop/orders/export-production/", views.OrderProductionExportView.as_view(), name="order_production_export"),
    path("shop/orders/export-production/<str:token>/", views.OrderProductionDownloadView.as_view(), name="order_production_download"),
    path("shop/orders/reprint-production/", views.OrderProductionReprintView.as_view(), name="order_production_reprint"),
    path("shop/orders/receive-production/", views.OrderReceiveProductionView.as_view(), name="order_receive_production"),
    path("shop/orders/ready-for-pickup/", views.OrderReadyForPickupView.as_view(), name="order_ready_for_pickup"),
    path("shop/orders/bulk/mark-paid/", views.OrderBulkMarkPaidView.as_view(), name="order_bulk_mark_paid"),
    path("shop/orders/bulk/mark-ready-for-pickup/", views.OrderBulkMarkReadyForPickupView.as_view(), name="order_bulk_mark_ready_for_pickup"),
    ...
    path("shop/orders/<uuid:pk>/mark-ready-for-pickup/", views.OrderMarkReadyForPickupView.as_view(), name="order_mark_ready_for_pickup"),
    ...
    path("registrations/<uuid:pk>/cancel/", views.RegistrationBatchCancelView.as_view(), name="registration_invoice_cancel"),
    path("registrations/<uuid:pk>/", views.RegistrationInvoiceDetailView.as_view(), name="registration_invoice_detail"),
    path("registrations/<uuid:pk>/mark-paid/", views.RegistrationInvoiceMarkPaidView.as_view(), name="registration_invoice_mark_paid"),
    # Forms
