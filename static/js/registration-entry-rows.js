 ...
 *
 * The jersey-number field itself no longer lives in this row at all -- once
 * a team is picked here, its number is chosen on the price/confirm screen
 * instead (registration.services.pricing.jersey_choices_for_entry scopes
 * its choices server-side by then, so there's nothing left for this script
 * to narrow client-side).
 */
(() => {
