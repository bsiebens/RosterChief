...
urlpatterns = [
    ...
    path("coach/events/<uuid:pk>/", coach_views.CoachEventDetailView.as_view(), name="coach_event_detail"),
    path("coach/events/<uuid:pk>/edit/", coach_views.CoachEditEventView.as_view(), name="coach_edit_event"),
    path("coach/events/<uuid:pk>/detach/", coach_views.CoachEventDetachView.as_view(), name="coach_event_detach"),
    path("coach/events/<uuid:pk>/tasks/create/", coach_views.CoachEventTaskCreateView.as_view(), name="coach_event_task_create"),
    path("coach/events/<uuid:pk>/tasks/<uuid:task_pk>/update/", coach_views.CoachEventTaskUpdateView.as_view(), name="coach_event_task_update"),
    path("coach/events/<uuid:pk>/tasks/<uuid:task_pk>/delete/", coach_views.CoachEventTaskDeleteView.as_view(), name="coach_event_task_delete"),
    path("coach/series/<uuid:pk>/edit/", coach_views.CoachEditEventSeriesView.as_view(), name="coach_edit_event_series"),
